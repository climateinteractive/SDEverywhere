...
import type { GraphId, GraphSpec } from './spec-types/graphs'
...
export function generateConfigSpecs(context: ConfigContext): ConfigSpecs {
  ...
  // const inputsConfig = generateInputsConfig(context)
...
export function writeConfigSpecs(context: ConfigContext, config: ConfigSpecs, dstDir: string): void {
  ...
  emit('// This file is generated by `@sdeverywhere/plugin-config-csv`; do not edit manually!')
  emit('')
  emit(`import type { GraphSpec } from 'TODO'`)
  // emit(`import type { InputSpec } from 'TODO'`)
