...
/**
 * Describes a model (e.g., a Vensim `mdl` file or Stella `stmx` file) and the input/output
 * variables that should be included in the model generated by SDEverywhere.
 */
 ...
 * variables that should be included in the model generated by SDEverywhere.
 *
 * This is largely the same as the `ModelSpec` interface, except this one has been
