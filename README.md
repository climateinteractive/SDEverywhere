...
SDEverywhere supports a broad range of System Dynamics models saved in the [Vensim](https://www.vensim.com) and [Stella](https://www.iseesystems.com/store/products/index.aspx) file formats.

- **Vensim**: SDEverywhere supports many features of the [Vensim modeling language](https://www.vensim.com/documentation/index.html?ref_language.htm), including subscripts, subranges, and subscript mapping.
...
- **Stella**: SDEverywhere supports reading models in the [XMILE](http://docs.oasis-open.org/xmile/xmile/v1.0/xmile-v1.0.html) format as used by [Stella](https://www.iseesystems.com) products.
  The full list of XMILE/Stella functions that are implemented in SDEverywhere can be found on the [Supported XMILE and Stella Functions](https://github.com/climateinteractive/SDEverywhere/wiki/Supported-XMILE-and-Stella-Functions) page in the SDEverywhere [wiki](https://github.com/climateinteractive/SDEverywhere/wiki).
...
At its core, SDEverywhere includes a [transpiler](https://en.wikipedia.org/wiki/Source-to-source_compiler) that can read a Vensim or Stella model and generate a high-performance version of that model as JavaScript or C code.
...
SDEverywhere covers a subset of the Vensim and Stella file formats that are used in real-world models.
