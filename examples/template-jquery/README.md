...
#   - the config files
#   - the model file (<name>.mdl or <name>.stmx)
...
- The sample Vensim model is in `model/{MODEL_NAME}.mdl`. You can replace this with
  your own Vensim `mdl` or Stella `stmx` model file.
