...
/**
 * Return a `ComparisonReportOptions` instance that demonstrates customization options for the
 * comparison summary and detail views in the generated report.
 */
export function getComparisonReportOptions(nameL: string, nameR: string): ComparisonReportOptions {
  return {
